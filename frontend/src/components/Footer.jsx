            ...
            <div className={styles.part3}>
                ...
                <div>
                    ...
                    <div className={styles.movies}>
                        ...
                        <div className={styles.line}></div>
                        <Link to="/explore/classNameic-movies" className={styles.link}>classNameic Movies</Link>
                    </div>
                </div>
                <div>
                    <div>Upcomimg Movies</div>
                    <div className={styles.movies}>
                        ...
                        <div className={styles.line}></div>
                        <Link to="/explore/classNameic-plays" className={styles.link}>classNameic Plays</Link>
                        <div className={styles.line}></div>
